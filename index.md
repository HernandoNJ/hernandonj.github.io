# Hernando Nieto | Unity C# developer Portfolio
...
**VR app to show apartments indoor**

- Users can walk inside the apartments in different levels of the building.
- Immersive experience to preview different parts of the apartment before it is done.

Link: [Torres 360 VR - Meta](https://www.meta.com/experiences/torres-360/7541646075899905)
...
<div  align="center"
  ...
  <img
    src="https://img.itch.zone/aW1hZ2UvMzkwNjAwNi8yMzMwMzA2OS5wbmc=/original/48i5FG.png"
    alt="Galaxy Shooter Game"
    width="500"
    height="250"
    style="border-radius: 5px; border: 1px solid #ddd; margin: 5px;"
  />
  <img
    src="https://img.itch.zone/aW1hZ2UvMzkwNjAwNi8yMzMwMzA3MC5wbmc=/original/8gnV%2B7.png"
    alt="Galaxy Shooter Game"
    width="500"
    height="250"
    style="border-radius: 5px; border: 1px solid #ddd; margin: 5px;"
...
**2D game for pc with shooting mechanics and player status updates and upgrades**

- Spaceship as galaxy shooter with 2D model and physics.
- Interaction with game items such as enemies and powerups.
- Health, bullets and AI boss implemented.
...
<div  align="center"
      style="display: flex; justify-content: center; flex-wrap: wrap; gap: 10px; padding: 5px;">
  <img
    src="https://img.itch.zone/aW1hZ2UvMjA2Nzk4NS8xMjE2MDkxMi5qcGc=/original/o6U5wa.jpg"
    alt="Stealth Game"
    width="500"
    height="250"
    style="border-radius: 5px; border: 1px solid #ddd; margin: 5px;"
  />
  <img
    src="https://img.itch.zone/aW1hZ2UvMjA2Nzk4NS8xMjE2MDkxNC5qcGc=/original/EBkLJN.jpg"
    alt="Stealth Game"
    width="500"
    height="250"
    style="border-radius: 5px; border: 1px solid #ddd; margin: 5px;"
...
**3D game with intro scene including cinematic footage with video and audio for pc**
